    ...
    public partial class initialdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComplianceReports", x => x.CRId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    EPFPercentage = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    ...
                    HRAAllowancePercentage = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    BonusPercentage = table.Column<decimal>(type: "decimal(5,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayrollPolicies", x => x.PayrollPolicyId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Grades_PayrollPolicies_PayrollPolicyId",
                        column: x => x.PayrollPolicyId,
                        principalTable: "PayrollPolicies",
                        principalColumn: "PayrollPolicyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Grades_PayrollPolicyId",
                table: "Grades",
